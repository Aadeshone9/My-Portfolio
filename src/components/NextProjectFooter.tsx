        ...
        >
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="space-y-6">
              ...
              <div className="h-[48px] px-6 bg-white rounded-lg flex items-center justify-center inline-flex shadow-sm">
              ...
              <h3 className="font-headline font-semibold text-2xl md:text-3xl lg:text-4xl text-foreground">
