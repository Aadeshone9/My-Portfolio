...
export const projectsData: ProjectData = {
  vida: {
    ...
    rationales: [
      ...
      {
        title: 'Eco-Footprint & Incentives',
        icon: 'Zap',
        points: [
          { title: 'Gamification', description: 'Incentivizing sustainable riding through "Earth Points" and leaderboard visibility.' },
          { title: 'Visual Feedback', description: 'Real-time eco-mode status and historical savings visualized for immediate user gratification.' },
        ]
      },
      {
        ...
        icon: 'Cog',
        points: [
          { title: 'Connected Experience', description: 'Seamless integration with roadside assistance and service history.' },
          { title: 'Proactive Support', description: 'Leveraging vehicle diagnostics to predict and prevent potential breakdowns before they occur.' },
        ]
      },
      {
        ...
        icon: 'Layers',
        points: [
          { title: 'Value Proposition', description: 'Clear tiered benefit visualization to drive LTV and reduce churn.' },
          { title: 'Renewal Optimization', description: 'Personalized renewal prompts based on vehicle usage patterns and upcoming service milestones.' },
        ]
      }
    ],
    ...
    experienceEnhancers: [
      { icon: 'Package', title: 'Services and Subscriptions', description: 'Drive subscriptions and show value with contextual nudges for pre-paid services.' },
      { icon: 'FileText', title: 'Reports and Analytics', description: 'Provided client with performance data tracking, analytics, and insightful reports.' },
      { icon: 'Navigation', title: 'Tailored Navigation', description: 'Personalized navigation to increase user engagement.' },
      { icon: 'Phone', title: 'Roadside Assistance', description: 'Dependable roadside assistance for emergencies and breakdowns.' },
      { icon: 'Navigation', title: 'Custom Riding Mode', description: 'Streamline journeys with our centralized route planner and access.' },
      { icon: 'Shield', title: 'Priority Safety and Security', description: 'Enhanced user control and visibility of vehicle usage and status for safer and more secure driving.' },
      { icon: 'Fence', title: 'Geo-Fencing', description: 'Boost sales by offering informative content to aid decision-making on website and app.' },
    ],
    
    customerImpact: [
      { icon: 'Users', title: 'The Bigger Picture', description: 'Empowering users to engage and participate in a larger community for a sense of inclusivity and involvement.' },
      { icon: 'Cog', title: 'Easy and Quick Maintenance', description: 'Using an advanced system that proactively alerts users of potential issues and simplifies maintenance.' },
      { icon: 'Ear', title: 'Assistance and Support', description: "Providing a comprehensive and supportive experience as a dependable companion for the user's journey." },
      { icon: 'Cloud', title: 'Eco-friendly Tools', description: "Promoting eco-conscious choices by displaying users' eco-footprint as earth points." },
      { icon: 'CheckCircle', title: 'Hassle Free Ownership', description: 'Leveraging intelligent technology for personalized and relevant recommendations and insights.' },
    ],
    
    imageStrategy: {
      placement: 'alternating',
      rationaleImages: {
        0: ['project1-image-2', 'project1-image-3'],
        1: ['project1-image-4'],
        2: ['project1-image-7'],
        3: ['project1-image-5'],
        4: ['project1-image-6'],
  ...
  maplegeni: {
    ...
    imageStrategy: {
      ...
      rationaleImages: {
        ...
        1: ['project4-image-3'],
        2: ['project4-image-5'],
        3: ['project4-image-4'], // Interactive prototype
      },
      inlineContent: {
        3: 'figma-maplegeni'
      }
  ...
  'thermax-edge': {
    ...
    methodology: [
      { icon: 'ClipboardCheck', title: 'Heuristic Evaluation', description: 'Applied 10 Usability Heuristics to identify severe interface violations affecting operational safety.' },
      { icon: 'Users', title: 'User Task Analysis', description: 'Deep-dive interviews and observations with 70+ Plant Managers to map 20+ critical operational paths.' },
      { icon: 'BarChart3', title: 'Research Benchmarking', description: 'Quantitative performance measurement against industry standards to justify the ROI of design debt resolution.' },
      { icon: 'Map', title: 'Strategic Roadmap', description: 'A prioritized 12-month evolution blueprint balanced against technical feasibility and business urgency.' },
    ],
...
export const getProjectConfig = (slug: string) => {
  return projectsData[slug] || projectsData['vida'];
};
